...
const ROLE_PERMISSIONS: Record<AppRole, readonly Permission[]> = {
  ...
  INCIDENT_SUPERVISOR: ["towers.read", "visits.read", "incidents.read", "inventory.read"],
};
...
export const canAccessRoute = (role: AppRole, pathname: string) => pathname.startsWith("/admin") ? role === "ADMIN" : true;

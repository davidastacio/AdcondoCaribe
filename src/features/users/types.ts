export type AppRole="ADMIN"|"SUPERVISOR";export type UserStatus="ACTIVE"|"INACTIVE"|"SUSPENDED"|"PENDING";export type AssignmentStatus="ACTIVE"|"ENDED"|"SUSPENDED";
...
export interface TowerAssignment{id:string;towerId:string;supervisorId:string;assignedById:string;assignedBy:string;status:AssignmentStatus;startDate:string;endDate?:string;endedBy?:string;notes?:string;createdAt:string;updatedAt:string}
